...
export const jobsApi = {
  list: (params: ListJobsParams = {}) => api.get<JobListItem[]>(`/jobs${toQueryString(params)}`),
  ...
  extractJobInfo: (pastedText: string) =>
    api.post<ExtractedJobInfo>('/jobs/extract', { pastedText }),
};
